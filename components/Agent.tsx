...
const Agent = ({userName , userId , type, interviewId, questions}:AgentProps) => {
    ...
    // this effect handles what the system should do when certain call states are triggered by vapi
            ...
            {messages.length > 0 && (
                <div className="transcript-border">
                    <div className="transcript">
                        <p key={lastestMessage} className={cn('transition-opacity duration-500 opacity-0',
